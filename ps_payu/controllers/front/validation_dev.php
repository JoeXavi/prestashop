...
class Ps_PayUValidationModuleFrontController extends ModuleFrontController {
    ...
    public function postProcess() {
        ...
        $myfile = fopen("ParamsInPayu.txt", "a") or die("Unable to open file!");
            fwrite($myfile,"IdCart:".$cart->id."/StateOrder:".$order_state_pending."/Total:". $total ."/displayName:". $this->module->displayName. "/CurrencyID:".$currency->id."/CustomerKey:".$customer->secure_key ." ". date("Y-m-d H:i:s")."\n");
            fclose($myfile);
